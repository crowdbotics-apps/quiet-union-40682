"""
Django settings for quiet_union_40682 project.
...
ROOT_URLCONF = 'quiet_union_40682.urls'
...
WSGI_APPLICATION = 'quiet_union_40682.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_union_40682 API",
    "DESCRIPTION": "API documentation for quiet_union_40682 App",
    "VERSION": "v1",
}
